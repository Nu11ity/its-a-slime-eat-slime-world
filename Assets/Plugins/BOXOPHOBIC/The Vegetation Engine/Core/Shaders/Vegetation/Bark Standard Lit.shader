	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half Mesh_Motion_260_g18215 = v.ase_texcoord3.y;
				...
				float temp_output_342_0_g18262 = ( MotionVariation264_g18215 * v.ase_color.r );
				...
				half Mesh_Motion_182_g18215 = v.ase_texcoord3.x;
				...
				float temp_output_342_0_g18302 = ( -MotionVariation264_g18215 * v.ase_color.r );
				...
				float3 Vertex_Motion_World1118_g18215 = ( ( ( v.vertex.xyz + appendResult2047_g18215 ) + appendResult2043_g18215 ) + Motion_Vertical223_g18215 );
				...
				float lerpResult348_g18215 = lerp( 1.0 , saturate( ( ( distance( _WorldSpaceCameraPos , appendResult20_g18274 ) - temp_output_7_0_g18269 ) / ( Global_SizeFadeStart276_g18215 - temp_output_7_0_g18269 ) ) ) , _GlobalSizeFade);
				...
				float3 Final_Vertex890_g18215 = ( ( staticSwitch14_g18272 * Vertex_SizeFade1740_g18215 * Vertex_Size1741_g18215 ) + ( _IsUniversalPipeline * 0.0 ) );
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float2 Main_UVs15_g18215 = ( ( IN.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				#endif
				half Mesh_DetailMask90_g18215 = IN.ase_color.b;
				...
				float3 lerpResult235_g18215 = lerp( Main_AlbedoColored863_g18215 , ( Main_AlbedoColored863_g18215 * Second_AlbedoColored1963_g18215 * staticSwitch1_g18282 ) , Mask_Detail147_g18215);
				...
				float3 switchResult1063_g18215 = (((ase_vface>0)?(Blend_NormalRaw1051_g18215):(( Blend_NormalRaw1051_g18215 * float3(-1,-1,-1) ))));
				...
				half Second_Smoothness236_g18215 = ( tex2DNode33_g18215.a * _SecondSmoothnessValue );
				float lerpResult266_g18215 = lerp( Main_Smoothness227_g18215 , Second_Smoothness236_g18215 , Mask_Detail147_g18215);
				#if defined(MATERIAL_USE_DETAIL_OFF)
				float staticSwitch297_g18215 = Main_Smoothness227_g18215;
				#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float staticSwitch297_g18215 = Main_Smoothness227_g18215;
				#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float staticSwitch297_g18215 = lerpResult266_g18215;
				#else
				float staticSwitch297_g18215 = Main_Smoothness227_g18215;
				#endif
				half Blend_Smoothness314_g18215 = staticSwitch297_g18215;
				...
				half Mesh_Occlusion318_g18215 = IN.ase_color.g;
				...
				float lerpResult239_g18215 = lerp( 1.0 , tex2DNode33_g18215.g , _SecondOcclusionValue);
				half Second_Occlusion251_g18215 = lerpResult239_g18215;
				float lerpResult294_g18215 = lerp( Main_Occlusion247_g18215 , Second_Occlusion251_g18215 , Mask_Detail147_g18215);
				#if defined(MATERIAL_USE_DETAIL_OFF)
				float staticSwitch310_g18215 = Main_Occlusion247_g18215;
				#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float staticSwitch310_g18215 = ( Main_Occlusion247_g18215 * Second_Occlusion251_g18215 );
				#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float staticSwitch310_g18215 = lerpResult294_g18215;
				#else
				float staticSwitch310_g18215 = Main_Occlusion247_g18215;
				#endif
				half Blend_Occlusion323_g18215 = staticSwitch310_g18215;
				...
				float3 Albedo = ( Final_Albedo359_g18215 * Final_Premultiply355_g18215 );
				float3 Normal = Final_Normal366_g18215;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = lerpResult1037_g18215;
				float Occlusion = ( Vertex_Occlusion648_g18215 * Blend_Occlusion323_g18215 );
				float Alpha = Main_Alpha316_g18215;
				float AlphaClipThreshold = Final_Clip914_g18215;
				float3 BakedGI = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 Main_UVs15_g18215 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g18215 = tex2D( _MainAlbedoTex, Main_UVs15_g18215 );
				float4 temp_output_51_0_g18215 = ( _MainColor * tex2DNode29_g18215 );
				half Main_Alpha316_g18215 = (temp_output_51_0_g18215).a;
...
/*ASEBEGIN
Version=18103
1927;7;1906;1015;2834.774;549.811;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;304;-2176,-128;Inherit;False;Base Shader;1;;18215;856f7164d1c579d43a5cf4968a75ca43;51,1271,2,1300,1,1298,1,1962,0,1708,0,1712,1,1964,1,1969,1,1723,0,1719,0,893,0,1745,1,1742,1,1714,1,1718,1,1715,1,1717,1,1728,1,1732,1,916,1,1949,1,1762,1,1763,1,1776,0,1966,1,1736,1,1735,1,1734,1,1737,1,1968,1,1733,1,878,0,1550,0,1646,0,1690,0,1757,0,1669,0,1981,0,1759,0,860,1,2055,1,2031,1,2054,1,2032,1,2057,1,2033,1,2036,0,2060,0,2039,0,2062,0,1785,1;0;14;FLOAT3;0;FLOAT3;528;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
...
Node;AmplifyShaderEditor.FunctionNode;305;-2176,256;Inherit;False;Base Batching;144;;18214;d914b3a554b05ab4da8c1d2a8ce94c0a;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;311;-1376,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;307;-1376,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;308;-1376,-128;Float;False;True;-1;2;TVEShaderCoreGUI;0;2;BOXOPHOBIC/The Vegetation Engine/Vegetation/Bark Standard Lit;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;16;False;False;False;True;2;True;10;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;True;17;True;0;False;-1;True;True;0;False;-1;-1;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;33;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Transmission;0;  Transmission Shadow;0.5,True,278;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;0;0;6;False;True;True;True;True;True;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;309;-1376,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;310;-1376,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;312;-1376,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;False;True;1;True;17;True;0;False;-1;True;True;0;False;-1;-1;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
...
WireConnection;308;1;304;528
WireConnection;308;4;304;530
WireConnection;308;5;304;531
WireConnection;308;6;304;532
WireConnection;308;7;304;653
WireConnection;308;8;304;534
ASEEND*/
//CHKSM=AC5D2BF48459678378729EAAF6CA61BAB24FF4F9
