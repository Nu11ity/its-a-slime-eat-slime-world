	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float Vertex_SizeFade1740_g16634 = 1.0;
				half Vertex_Size1741_g16634 = 1.0;
				float3 Final_Vertex890_g16634 = ( ( v.vertex.xyz * Vertex_SizeFade1740_g16634 * Vertex_Size1741_g16634 ) + ( _IsUniversalPipeline * 0.0 ) );
				...
				#endif
				float3 vertexValue = Final_Vertex890_g16634;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float2 Main_UVs15_g16634 = ( ( IN.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g16634 = tex2D( _MainAlbedoTex, Main_UVs15_g16634 );
				float4 temp_output_51_0_g16634 = ( _MainColor * tex2DNode29_g16634 );
				half3 Main_AlbedoRaw99_g16634 = (temp_output_51_0_g16634).rgb;
				half3 Main_AlbedoColored863_g16634 = Main_AlbedoRaw99_g16634;
				float2 Second_UVs17_g16634 = ( ( (WorldPosition).xz * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo153_g16634 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g16634 ) )).rgb;
				half3 Second_AlbedoColored1963_g16634 = Second_Albedo153_g16634;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g18282 = 2.0;
				#else
				float staticSwitch1_g18282 = 4.594794;
				#endif
				float3 lerpResult1537_g16634 = lerp( float3(0,1,0) , float3(0,-1,0) , _DetailProjectionMode);
				float dotResult1532_g16634 = dot( WorldNormal , lerpResult1537_g16634 );
				half Blend_Source1540_g16634 = ( ( dotResult1532_g16634 * 0.5 ) + _DetailMeshValue );
				float4 tex2DNode35_g16634 = tex2D( _MainMaskTex, Main_UVs15_g16634 );
				half Main_Mask57_g16634 = tex2DNode35_g16634.b;
				float4 tex2DNode33_g16634 = tex2D( _SecondMaskTex, Second_UVs17_g16634 );
				half Second_Mask81_g16634 = tex2DNode33_g16634.b;
				float lerpResult1327_g16634 = lerp( Main_Mask57_g16634 , Second_Mask81_g16634 , _MaskMode);
				float temp_output_7_0_g18284 = _DetailMaskContrast;
				half AutoRegister_DetailMode667_g16634 = ( 0.0 * _DetailMode * _DetailShadingCat );
				half Mask_Detail147_g16634 = ( saturate( ( ( saturate( ( Blend_Source1540_g16634 + ( Blend_Source1540_g16634 * ( ( ( 1.0 - lerpResult1327_g16634 ) - 0.5 ) + _DetailMaskValue ) ) ) ) - temp_output_7_0_g18284 ) / ( ( 1.0 - _DetailMaskContrast ) - temp_output_7_0_g18284 ) ) ) + AutoRegister_DetailMode667_g16634 );
				float3 lerpResult235_g16634 = lerp( Main_AlbedoColored863_g16634 , ( Main_AlbedoColored863_g16634 * Second_AlbedoColored1963_g16634 * staticSwitch1_g18282 ) , Mask_Detail147_g16634);
				float3 lerpResult208_g16634 = lerp( Main_AlbedoColored863_g16634 , Second_AlbedoColored1963_g16634 , Mask_Detail147_g16634);
				#if defined(MATERIAL_USE_DETAIL_OFF)
				float3 staticSwitch255_g16634 = Main_AlbedoColored863_g16634;
				#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float3 staticSwitch255_g16634 = lerpResult235_g16634;
				#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float3 staticSwitch255_g16634 = lerpResult208_g16634;
				#else
				float3 staticSwitch255_g16634 = Main_AlbedoColored863_g16634;
				#endif
				half3 Blend_Albedo265_g16634 = staticSwitch255_g16634;
				half3 Blend_AlbedoAndSubsurface149_g16634 = Blend_Albedo265_g16634;
				float3 temp_output_44_0_g18258 = (TVE_OverlayColor).rgb;
				half3 Global_OverlayColor1758_g16634 = temp_output_44_0_g18258;
				float4 tex2DNode117_g16634 = tex2D( _MainNormalTex, Main_UVs15_g16634 );
				float2 appendResult88_g18301 = (float2(tex2DNode117_g16634.a , tex2DNode117_g16634.g));
				...
				float3 Main_Normal137_g16634 = appendResult91_g18301;
				float4 tex2DNode145_g16634 = tex2D( _SecondNormalTex, Second_UVs17_g16634 );
				float2 appendResult88_g18256 = (float2(tex2DNode145_g16634.a , tex2DNode145_g16634.g));
				...
				float3 Second_Normal179_g16634 = appendResult91_g18256;
				float3 lerpResult230_g16634 = lerp( float3( 0,0,1 ) , Second_Normal179_g16634 , Mask_Detail147_g16634);
				float3 lerpResult249_g16634 = lerp( Main_Normal137_g16634 , Second_Normal179_g16634 , Mask_Detail147_g16634);
				#if defined(MATERIAL_USE_DETAIL_OFF)
				float3 staticSwitch267_g16634 = Main_Normal137_g16634;
				#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float3 staticSwitch267_g16634 = BlendNormal( Main_Normal137_g16634 , lerpResult230_g16634 );
				#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float3 staticSwitch267_g16634 = lerpResult249_g16634;
				#else
				float3 staticSwitch267_g16634 = Main_Normal137_g16634;
				#endif
				float3 Blend_NormalRaw1051_g16634 = staticSwitch267_g16634;
				float3 switchResult1063_g16634 = (((ase_vface>0)?(Blend_NormalRaw1051_g16634):(( Blend_NormalRaw1051_g16634 * float3(-1,-1,-1) ))));
				half Overlay_Contrast1405_g16634 = _OverlayContrast;
				float3 appendResult1439_g16634 = (float3(Overlay_Contrast1405_g16634 , Overlay_Contrast1405_g16634 , 1.0));
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal178_g16634 = ( switchResult1063_g16634 * appendResult1439_g16634 );
				float3 worldNormal178_g16634 = float3(dot(tanToWorld0,tanNormal178_g16634), dot(tanToWorld1,tanNormal178_g16634), dot(tanToWorld2,tanNormal178_g16634));
				half Global_OverlayIntensity154_g16634 = TVE_OverlayIntensity;
				...
				half Global_ExtrasTex_B156_g16634 = tex2DNode7_g18297.b;
				float temp_output_1025_0_g16634 = ( Global_OverlayIntensity154_g16634 * _GlobalOverlay * Global_ExtrasTex_B156_g16634 );
				half Overlay_Commons1365_g16634 = temp_output_1025_0_g16634;
				half Overlay_Mask269_g16634 = saturate( ( saturate( worldNormal178_g16634.y ) - ( 1.0 - Overlay_Commons1365_g16634 ) ) );
				float3 lerpResult336_g16634 = lerp( Blend_AlbedoAndSubsurface149_g16634 , Global_OverlayColor1758_g16634 , Overlay_Mask269_g16634);
				half3 Final_Albedo359_g16634 = lerpResult336_g16634;
				half Main_Alpha316_g16634 = (temp_output_51_0_g16634).a;
				float lerpResult354_g16634 = lerp( 1.0 , Main_Alpha316_g16634 , __premul);
				half Final_Premultiply355_g16634 = lerpResult354_g16634;
				
				float3 temp_output_13_0_g18300 = staticSwitch267_g16634;
				float3 switchResult12_g18300 = (((ase_vface>0)?(temp_output_13_0_g18300):(( temp_output_13_0_g18300 * _render_normals_options ))));
				half3 Blend_Normal312_g16634 = switchResult12_g18300;
				half3 Final_Normal366_g16634 = Blend_Normal312_g16634;
				
				half Global_Wetness1016_g16634 = ( TVE_Wetness * _GlobalWetness );
				half Global_ExtrasTex_A1033_g16634 = tex2DNode7_g18297.a;
				float lerpResult1037_g16634 = lerp( _ObjectSmoothnessValue , saturate( ( _ObjectSmoothnessValue + Global_Wetness1016_g16634 ) ) , Global_ExtrasTex_A1033_g16634);
				
				float localCustomAlphaClip9_g18277 = ( 0.0 );
				half Main_AlphaRaw1203_g16634 = tex2DNode29_g16634.a;
				half Alpha5_g18277 = Main_AlphaRaw1203_g16634;
				float Alpha9_g18277 = Alpha5_g18277;
				float AlphaClipThreshold9_g18277 = _Cutoff;
				#if _ALPHATEST_ON
				clip(Alpha9_g18277 - AlphaClipThreshold9_g18277);
				#endif
				half Final_Clip914_g16634 = localCustomAlphaClip9_g18277;
				
				float3 Albedo = ( Final_Albedo359_g16634 * Final_Premultiply355_g16634 );
				float3 Normal = Final_Normal366_g16634;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = _ObjectMetallicValue;
				float Smoothness = lerpResult1037_g16634;
				float Occlusion = 1;
				float Alpha = Main_Alpha316_g16634;
				float AlphaClipThreshold = Final_Clip914_g16634;
				float3 BakedGI = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 Main_UVs15_g16634 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g16634 = tex2D( _MainAlbedoTex, Main_UVs15_g16634 );
				float4 temp_output_51_0_g16634 = ( _MainColor * tex2DNode29_g16634 );
				half Main_Alpha316_g16634 = (temp_output_51_0_g16634).a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , half ase_vface : VFACE ) : SV_TARGET
			{
				...
				float3 lerpResult1537_g16634 = lerp( float3(0,1,0) , float3(0,-1,0) , _DetailProjectionMode);
				float dotResult1532_g16634 = dot( ase_worldNormal , lerpResult1537_g16634 );
				half Blend_Source1540_g16634 = ( ( dotResult1532_g16634 * 0.5 ) + _DetailMeshValue );
				float4 tex2DNode35_g16634 = tex2D( _MainMaskTex, Main_UVs15_g16634 );
				half Main_Mask57_g16634 = tex2DNode35_g16634.b;
				float4 tex2DNode33_g16634 = tex2D( _SecondMaskTex, Second_UVs17_g16634 );
...
/*ASEBEGIN
Version=18103
1927;7;1906;1015;3017.106;912.3311;1;True;False
...
WireConnection;162;1;152;528
WireConnection;162;3;152;529
WireConnection;162;4;152;530
WireConnection;162;6;152;532
WireConnection;162;7;152;653
WireConnection;162;8;152;534
ASEEND*/
//CHKSM=AD4A4147CE47F34F7AA76599C2BAD7754921039A
