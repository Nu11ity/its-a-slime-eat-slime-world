	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float Vertex_SizeFade1740_g16884 = 1.0;
				half Vertex_Size1741_g16884 = 1.0;
				float3 Final_Vertex890_g16884 = ( ( v.vertex.xyz * Vertex_SizeFade1740_g16884 * Vertex_Size1741_g16884 ) + ( _IsUniversalPipeline * 0.0 ) );
				...
				#endif
				float3 vertexValue = Final_Vertex890_g16884;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float2 Main_UVs15_g16884 = ( ( IN.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g16884 = tex2D( _MainAlbedoTex, Main_UVs15_g16884 );
				float4 temp_output_51_0_g16884 = ( _MainColor * tex2DNode29_g16884 );
				half3 Main_AlbedoRaw99_g16884 = (temp_output_51_0_g16884).rgb;
				half3 Main_AlbedoColored863_g16884 = Main_AlbedoRaw99_g16884;
				float2 lerpResult1545_g16884 = lerp( IN.ase_texcoord7.xy , IN.ase_texcoord8.xy , _DetailCoordMode);
				float2 Second_UVs17_g16884 = ( ( lerpResult1545_g16884 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo153_g16884 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g16884 ) )).rgb;
				half3 Second_AlbedoColored1963_g16884 = Second_Albedo153_g16884;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g18282 = 2.0;
				#else
				float staticSwitch1_g18282 = 4.594794;
				#endif
				half Mesh_DetailMask90_g16884 = IN.ase_color.b;
				float temp_output_989_0_g16884 = ( ( Mesh_DetailMask90_g16884 - 0.5 ) + _DetailMeshValue );
				half Blend_Source1540_g16884 = temp_output_989_0_g16884;
				float4 tex2DNode35_g16884 = tex2D( _MainMaskTex, Main_UVs15_g16884 );
				half Main_Mask57_g16884 = tex2DNode35_g16884.b;
				float4 tex2DNode33_g16884 = tex2D( _SecondMaskTex, Second_UVs17_g16884 );
				half Second_Mask81_g16884 = tex2DNode33_g16884.b;
				float lerpResult1327_g16884 = lerp( Main_Mask57_g16884 , Second_Mask81_g16884 , _MaskMode);
				float temp_output_7_0_g18284 = _DetailMaskContrast;
				half AutoRegister_DetailMode667_g16884 = ( 0.0 * _DetailMode * _DetailShadingCat );
				half Mask_Detail147_g16884 = ( saturate( ( ( saturate( ( Blend_Source1540_g16884 + ( Blend_Source1540_g16884 * ( ( ( 1.0 - lerpResult1327_g16884 ) - 0.5 ) + _DetailMaskValue ) ) ) ) - temp_output_7_0_g18284 ) / ( ( 1.0 - _DetailMaskContrast ) - temp_output_7_0_g18284 ) ) ) + AutoRegister_DetailMode667_g16884 );
				float3 lerpResult235_g16884 = lerp( Main_AlbedoColored863_g16884 , ( Main_AlbedoColored863_g16884 * Second_AlbedoColored1963_g16884 * staticSwitch1_g18282 ) , Mask_Detail147_g16884);
				float3 lerpResult208_g16884 = lerp( Main_AlbedoColored863_g16884 , Second_AlbedoColored1963_g16884 , Mask_Detail147_g16884);
				#if defined(MATERIAL_USE_DETAIL_OFF)
				float3 staticSwitch255_g16884 = Main_AlbedoColored863_g16884;
				#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float3 staticSwitch255_g16884 = lerpResult235_g16884;
				#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float3 staticSwitch255_g16884 = lerpResult208_g16884;
				#else
				float3 staticSwitch255_g16884 = Main_AlbedoColored863_g16884;
				#endif
				half3 Blend_Albedo265_g16884 = staticSwitch255_g16884;
				half3 Blend_AlbedoAndSubsurface149_g16884 = Blend_Albedo265_g16884;
				float3 temp_output_44_0_g18258 = (TVE_OverlayColor).rgb;
				half3 Global_OverlayColor1758_g16884 = temp_output_44_0_g18258;
				float4 tex2DNode117_g16884 = tex2D( _MainNormalTex, Main_UVs15_g16884 );
				float2 appendResult88_g18301 = (float2(tex2DNode117_g16884.a , tex2DNode117_g16884.g));
				...
				float3 Main_Normal137_g16884 = appendResult91_g18301;
				float4 tex2DNode145_g16884 = tex2D( _SecondNormalTex, Second_UVs17_g16884 );
				float2 appendResult88_g18256 = (float2(tex2DNode145_g16884.a , tex2DNode145_g16884.g));
				...
				float3 Second_Normal179_g16884 = appendResult91_g18256;
				float3 lerpResult230_g16884 = lerp( float3( 0,0,1 ) , Second_Normal179_g16884 , Mask_Detail147_g16884);
				float3 lerpResult249_g16884 = lerp( Main_Normal137_g16884 , Second_Normal179_g16884 , Mask_Detail147_g16884);
				#if defined(MATERIAL_USE_DETAIL_OFF)
				float3 staticSwitch267_g16884 = Main_Normal137_g16884;
				#elif defined(MATERIAL_USE_DETAIL_OVERLAY)
				float3 staticSwitch267_g16884 = BlendNormal( Main_Normal137_g16884 , lerpResult230_g16884 );
				#elif defined(MATERIAL_USE_DETAIL_HEIGHT)
				float3 staticSwitch267_g16884 = lerpResult249_g16884;
				#else
				float3 staticSwitch267_g16884 = Main_Normal137_g16884;
				#endif
				float3 Blend_NormalRaw1051_g16884 = staticSwitch267_g16884;
				float3 switchResult1063_g16884 = (((ase_vface>0)?(Blend_NormalRaw1051_g16884):(( Blend_NormalRaw1051_g16884 * float3(-1,-1,-1) ))));
				half Overlay_Contrast1405_g16884 = _OverlayContrast;
				float3 appendResult1439_g16884 = (float3(Overlay_Contrast1405_g16884 , Overlay_Contrast1405_g16884 , 1.0));
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal178_g16884 = ( switchResult1063_g16884 * appendResult1439_g16884 );
				float3 worldNormal178_g16884 = float3(dot(tanToWorld0,tanNormal178_g16884), dot(tanToWorld1,tanNormal178_g16884), dot(tanToWorld2,tanNormal178_g16884));
				half Global_OverlayIntensity154_g16884 = TVE_OverlayIntensity;
				...
				half Global_ExtrasTex_B156_g16884 = tex2DNode7_g18297.b;
				float temp_output_1025_0_g16884 = ( Global_OverlayIntensity154_g16884 * _GlobalOverlay * Global_ExtrasTex_B156_g16884 );
				half Overlay_Commons1365_g16884 = temp_output_1025_0_g16884;
				half Overlay_Mask269_g16884 = saturate( ( saturate( worldNormal178_g16884.y ) - ( 1.0 - Overlay_Commons1365_g16884 ) ) );
				float3 lerpResult336_g16884 = lerp( Blend_AlbedoAndSubsurface149_g16884 , Global_OverlayColor1758_g16884 , Overlay_Mask269_g16884);
				half3 Final_Albedo359_g16884 = lerpResult336_g16884;
				half Main_Alpha316_g16884 = (temp_output_51_0_g16884).a;
				float lerpResult354_g16884 = lerp( 1.0 , Main_Alpha316_g16884 , __premul);
				half Final_Premultiply355_g16884 = lerpResult354_g16884;
				
				float3 temp_output_13_0_g18300 = staticSwitch267_g16884;
				float3 switchResult12_g18300 = (((ase_vface>0)?(temp_output_13_0_g18300):(( temp_output_13_0_g18300 * _render_normals_options ))));
				half3 Blend_Normal312_g16884 = switchResult12_g18300;
				half3 Final_Normal366_g16884 = Blend_Normal312_g16884;
				
				half Global_Wetness1016_g16884 = ( TVE_Wetness * _GlobalWetness );
				half Global_ExtrasTex_A1033_g16884 = tex2DNode7_g18297.a;
				float lerpResult1037_g16884 = lerp( _ObjectSmoothnessValue , saturate( ( _ObjectSmoothnessValue + Global_Wetness1016_g16884 ) ) , Global_ExtrasTex_A1033_g16884);
				
				float localCustomAlphaClip9_g18277 = ( 0.0 );
				half Main_AlphaRaw1203_g16884 = tex2DNode29_g16884.a;
				half Alpha5_g18277 = Main_AlphaRaw1203_g16884;
				float Alpha9_g18277 = Alpha5_g18277;
				float AlphaClipThreshold9_g18277 = _Cutoff;
				#if _ALPHATEST_ON
				clip(Alpha9_g18277 - AlphaClipThreshold9_g18277);
				#endif
				half Final_Clip914_g16884 = localCustomAlphaClip9_g18277;
				
				float3 Albedo = ( Final_Albedo359_g16884 * Final_Premultiply355_g16884 );
				float3 Normal = Final_Normal366_g16884;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = _ObjectMetallicValue;
				float Smoothness = lerpResult1037_g16884;
				float Occlusion = 1;
				float Alpha = Main_Alpha316_g16884;
				float AlphaClipThreshold = Final_Clip914_g16884;
				float3 BakedGI = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 Main_UVs15_g16884 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g16884 = tex2D( _MainAlbedoTex, Main_UVs15_g16884 );
				float4 temp_output_51_0_g16884 = ( _MainColor * tex2DNode29_g16884 );
				half Main_Alpha316_g16884 = (temp_output_51_0_g16884).a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , half ase_vface : VFACE ) : SV_TARGET
			{
				...
				half3 Main_AlbedoRaw99_g16884 = (temp_output_51_0_g16884).rgb;
				half3 Main_AlbedoColored863_g16884 = Main_AlbedoRaw99_g16884;
				float2 lerpResult1545_g16884 = lerp( IN.ase_texcoord2.xy , IN.ase_texcoord3.xy , _DetailCoordMode);
				float2 Second_UVs17_g16884 = ( ( lerpResult1545_g16884 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo153_g16884 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g16884 ) )).rgb;
				half3 Second_AlbedoColored1963_g16884 = Second_Albedo153_g16884;
				#ifdef UNITY_COLORSPACE_GAMMA
...
/*ASEBEGIN
Version=18103
1927;7;1906;1015;2920.503;536.5702;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;154;-2176,-512;Inherit;False;Define Use World Data;-1;;18311;749c61e1189c7f8408d9e6db94560d1d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;166;-1408,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;False;True;1;True;17;True;0;False;-1;True;True;0;False;-1;-1;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;161;-1408,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;162;-1408,-128;Float;False;True;-1;2;TVEShaderCoreGUI;0;2;BOXOPHOBIC/The Vegetation Engine/Objects/Prop Simple Lit;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;16;False;False;False;True;2;True;10;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;True;17;True;0;False;-1;True;True;0;False;-1;-1;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;33;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Transmission;0;  Transmission Shadow;0.5,True,278;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;0;0;6;False;True;True;True;True;True;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;163;-1408,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;164;-1408,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;165;-1408,-128;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
...
WireConnection;162;1;159;528
WireConnection;162;3;159;529
WireConnection;162;4;159;530
WireConnection;162;6;159;532
WireConnection;162;7;159;653
WireConnection;162;8;159;534
ASEEND*/
//CHKSM=1A3C71823A1DA4332BDDF8E20D7CF168710187F6
