	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#endif
				float3 temp_output_34_0_g770 = staticSwitch1_g810;
				...
				#endif
				float3 WorldPosition2_g770 = WorldPosition;
				float3 normalizeResult147_g770 = normalize( ( WorldPosition2_g770 - _WorldSpaceCameraPos ) );
				float dotResult145_g770 = dot( normalizeResult147_g770 , SafeNormalize(_MainLightPosition.xyz) );
				half DirectionalMask30_g770 = ( (dotResult145_g770*0.5 + 0.5) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend );
				float3 lerpResult40_g770 = lerp( temp_output_34_0_g770 , staticSwitch1_g811 , DirectionalMask30_g770);
				#if defined(AHF_DIRECTIONALMODE_OFF)
				float3 staticSwitch45_g770 = temp_output_34_0_g770;
				#elif defined(AHF_DIRECTIONALMODE_ON)
				float3 staticSwitch45_g770 = lerpResult40_g770;
				#else
				float3 staticSwitch45_g770 = temp_output_34_0_g770;
				#endif
				float3 temp_output_89_86_g681 = staticSwitch45_g770;
				float temp_output_7_0_g805 = AHF_FogDistanceStart;
				half FogDistanceMask12_g770 = saturate( ( ( distance( WorldPosition2_g770 , _WorldSpaceCameraPos ) - temp_output_7_0_g805 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g805 ) ) );
				half3 AHF_FogAxisOption181_g770 = AHF_FogAxisOption;
				float3 break159_g770 = ( WorldPosition2_g770 * AHF_FogAxisOption181_g770 );
				float temp_output_7_0_g806 = AHF_FogHeightEnd;
				half FogHeightMask16_g770 = saturate( ( ( ( break159_g770.x + break159_g770.y + break159_g770.z ) - temp_output_7_0_g806 ) / ( AHF_FogHeightStart - temp_output_7_0_g806 ) ) );
				float temp_output_29_0_g770 = ( FogDistanceMask12_g770 * FogHeightMask16_g770 );
				float simplePerlin3D193_g770 = snoise( ( ( WorldPosition2_g770 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _TimeParameters.x ) ) );
				float temp_output_7_0_g808 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g770 = saturate( ( ( distance( WorldPosition2_g770 , _WorldSpaceCameraPos ) - temp_output_7_0_g808 ) / ( 0.0 - temp_output_7_0_g808 ) ) );
				float lerpResult198_g770 = lerp( 1.0 , (simplePerlin3D193_g770*0.5 + 0.5) , ( NoiseDistanceMask7_g770 * AHF_NoiseIntensity * AHF_NoiseModeBlend ));
				half NoiseSimplex3D24_g770 = lerpResult198_g770;
				#if defined(AHF_NOISEMODE_OFF)
				float staticSwitch42_g770 = temp_output_29_0_g770;
				#elif defined(AHF_NOISEMODE_PROCEDURAL3D)
				float staticSwitch42_g770 = ( temp_output_29_0_g770 * NoiseSimplex3D24_g770 );
				#else
				float staticSwitch42_g770 = temp_output_29_0_g770;
				#endif
				float temp_output_43_0_g770 = ( staticSwitch42_g770 * AHF_FogIntensity );
				float temp_output_89_87_g681 = temp_output_43_0_g770;
				float3 lerpResult82_g681 = lerp( temp_output_81_0_g681 , temp_output_89_86_g681 , temp_output_89_87_g681);
				#ifdef AHF_ENABLED
...
/*ASEBEGIN
Version=18103
1927;7;1906;1015;3584.377;460.4861;3.858602;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;85;2048,896;Float;False;True;-1;2;;0;2;Custom/My Transparent Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;16;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;33;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;0
...
ASEEND*/
//CHKSM=549044878A21905A79E64B3DF40FD98546265BEA